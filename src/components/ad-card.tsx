...
function AdCardItem() {
  return (
    <div className="rounded-lg border border-dashed border-sidebar-border bg-card px-4 py-5 tall:py-10 flex flex-col justify-center">
      ...
      <a
        ...
        className="mt-2 block text-xs  hover:text-foreground hover:underline"
      >
